  ...
  projects: [
    {
      ...
      use: {
        ...
        viewport: null, // { width: 1920, height: 1080 }, // Explicitly set the viewport size
        // deviceScaleFactor: 1, // Adjust scale factor if required
        launchOptions: {
          args: ['--start-maximized'], // Launch with a maximized window
        },
      },
    },
